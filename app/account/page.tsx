        ...
        <div className="auth-panel">
          <div className="auth-card">
            ...
            <form onSubmit={submitAuth}>
              ...
              {mode === "register" && <label className="terms-check"><input type="checkbox" required /> <span>আমি <Link href="/page/terms">শর্তাবলি</Link> ও <Link href="/page/privacy">গোপনীয়তা নীতি</Link> মেনে নিচ্ছি।</span></label>}
