...
export default function AdminLoginPage(){
  const router=useRouter(); const store=useStoreSettings(); const [error,setError]=useState(""); const [loading,setLoading]=useState(false);
